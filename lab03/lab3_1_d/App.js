  ...
  return (
    <View style={{flex: 1,alignItems: 'center',justifyContent: 'center',backgroundColor:'#31AA5230'}}>
      ...
      <View style={{flex: 2,alignItems: 'center',justifyContent: 'space-between',}}>
        ...
        <View style={{flexDirection:'row',width: 315,backgroundColor:'#C4C4C44D'}}>
      ...
      <View style={{flex: 1.5,alignItems: 'center',justifyContent: 'end',width:screenWidth}}>
      ...
      <View style={{flex: 1.5,alignItems: 'center',justifyContent: 'space-evenly'}}>
        ...
        <Text style={{color: '#5D25FA'}}onPress={() => Linking.openURL('http://google.com')}>
      ...
      <View style={{flex: 2,flexDirection: 'row',alignItems: 'center',justifyContent: 'center',width:screenWidth}}>
