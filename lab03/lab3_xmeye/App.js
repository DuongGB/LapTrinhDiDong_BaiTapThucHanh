  ...
  return (
    <View
      ...
      <View
        ...
        <View
          ...
          <View style={{ justifyContent: 'center', width: 50, height: 54 }}>
            <Icon name={'user'} size={40} color="#386FFC" />
          </View>
          <TextInput
        ...
        <View
          ...
          <View style={{ justifyContent: 'center', width: 50, height: 54 }}>
            <Icon name={'lock'} size={40} color="#386FFC" />
          </View>
          <TextInput
            style={[styles.textInput, { width: 250 }]}
      ...
      <View
        ...
        <View>
          <Image source={require('./assets/icon1,svg.svg')} />
        </View>
        <View>
        ...
        <View
          ...
          <Image source={require('./assets/brandico_facebook.png')} />
        </View>
      </View>
    </View>
  );
